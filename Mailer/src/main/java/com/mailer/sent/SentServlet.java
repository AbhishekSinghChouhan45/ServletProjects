...
public class SentServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
			...
			String adminMail = (String)se.getAttribute("adminMail");
				...
				pw.print("<h5 style='text-align: right'>Hi "+email+"</h5>");
			try {
				...
				if(rs.next()!=false) {
					...
					do{
					pw.println("<tr><td>"+rs.getString("SUBJECT")+"</td><td><a href='sentMessage?id="+rs.getString(1)+"'>"+rs.getString("MESSAGE").subSequence(0, 6)+"</a></td></tr>");
					}
					while(rs.next());
				}else {
...
//				}
				...
				System.out.println("Exception in SentServlet: \n\t\t"+e.getLocalizedMessage());
			}
	}
}	
